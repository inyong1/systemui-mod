 ...
 * minutes.
 */
public class ClockViewKanan extends TextView/* implements OnLongClickListener*/
{
    ...
    private void detekSeting()
    {
        ...
        jamKiri=Settings.System.getInt(contentResolver,ClockViewSetting.JAM_YANG_AKTIF,2)==3;
