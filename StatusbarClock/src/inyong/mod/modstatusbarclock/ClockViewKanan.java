package inyong.mod.modstatusbarclock;
 ...
 * minutes.
 */
public class ClockViewKanan extends TextView
{
    ...
    private static final int AM_PM_STYLE = AM_PM_STYLE_GONE;
		...
		//-----
		private boolean jamAktif=true, detikAktif=false,detikjalan=false,jamKanan=true;
		private String formatHari="";
		private int warnaJam=Color.GREEN;

		private void detekSeting()
		{
				detikAktif = Settings.System.getInt(contentResolver, ClockViewSetting.DETIK_AKTIF, 1) == 1;
				jamKanan=Settings.System.getInt(contentResolver,ClockViewSetting.JAM_YANG_AKTIF,2)==3;
				formatHari=ClockViewSetting.FORMAT_TAMPILAN_HARI[Settings.System.getInt(contentResolver,ClockViewSetting.FORMAT_HARI,0)];
				if(!formatHari.toString().contains("E")) formatHari="";
				warnaJam = Settings.System.getInt(contentResolver, ClockViewSetting.WARNA_JAM,Color.GREEN);
    ...
    public ClockViewKanan(Context context, AttributeSet attrs)
		{
        super(context, attrs);
