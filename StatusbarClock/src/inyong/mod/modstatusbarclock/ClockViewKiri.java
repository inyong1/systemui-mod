 ...
 * minutes.
 */
public class ClockViewKiri extends TextView
{
    ...
    private static final int AM_PM_STYLE = AM_PM_STYLE_GONE;
		...
		private void detekSeting()
		{
				...
				jamKiri=Settings.System.getInt(contentResolver,ClockViewSetting.JAM_YANG_AKTIF,2)==1;
    ...
    public ClockViewKiri(Context context, AttributeSet attrs)
		{
        super(context, attrs);
