 ...
 * minutes.
 */
public class ClockViewTengah extends TextView
{
    ...
    private static final int AM_PM_STYLE = AM_PM_STYLE_GONE;
		...
		//-----
		private boolean jamAktif=true, detikAktif=false,detikjalan=false,jamTengah=false;
		...
		private void detekSeting()
		{
				...
				jamTengah = Settings.System.getInt(contentResolver, ClockViewSetting.JAM_YANG_AKTIF, 2) == 2;
