...
import inyong.mod.statusbarclock.R;
public class ClockViewPreference extends PreferenceFragment implements OnPreferenceChangeListener,OnPreferenceClickListener
{
		...
		public boolean onPreferenceClick(Preference pref)
		{
				...
				{
						boolean detikAktif=sharedPref.getBoolean(pref.getKey(), true);
		...
		private void setsummary()
		{
				...
				boolean detikAktif=sharedPref.getBoolean(detikAktifCheckBox.getKey(), true);
				...
				int formatHari=Settings.System.getInt(contResolver,jamNamaHari.getKey(),0);
